...
RATE_LIMITS = {
    ...
    "moderate": os.getenv("RATE_LIMIT_MODERATE", "10/minute"), # Moderado - Listagens, buscas por ID, auditoria
    "low": os.getenv("RATE_LIMIT_LOW", "20/minute"), # Baixo - Health checks, endpoints de sistema, documentos
    "light": os.getenv("RATE_LIMIT_LIGHT", "30/minute"), # Leve - Endpoints públicos, documentação
    "default": os.getenv("RATE_LIMIT_DEFAULT", "60/minute") # Padrão para endpoints não especificados
}
